...
1. **supportModules** - (default: `env.RENDERER_SUPPORT_MODULES`) - Set this to true if you want the
   renderer to support Node modules, such as for `loadable-components`. Set to null if you want the execJS behavior.
