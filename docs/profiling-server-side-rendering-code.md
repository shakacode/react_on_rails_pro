...
By zooming into it, you can see the function that’s called `builsVM` (you can also search for it by clicking Ctrl+f and type the function name)
...
To check the profile of other requests, zoom into any the following spots of work
