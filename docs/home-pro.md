...
# Purchasing
See [React on Rails Pro](https://docs.google.com/document/d/1vwooIc6jKkuBOzllQ7rbVKMR2xOmeX0TpjHKxHcFyYo/edit#)
...
2. For each calendar month, up to one hour of support, via Slack, zoom, Github reviews, etc. or one hour removed from the invoice for additional consulting for the month at $125/hour.
