...
# Deprecated
**Please, see new doc about how to setup code splitting with loadable components.** [New doc](https://www.shakacode.com/react-on-rails-pro/docs/code-splitting-loadable-components/)
