...
module ReactOnRailsPro
  ...
  class Configuration
    ...
    DEFAULT_RENDERER_REQUEST_RETRY_COUNT = 5
    ...
    def initialize(renderer_url: nil, renderer_password: nil, server_renderer: nil,
                   ...
                   renderer_request_retry_count: nil)
      ...
      self.renderer_request_retry_count = renderer_request_retry_count
    end
