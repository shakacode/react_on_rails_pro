...
module ReactOnRailsPro
  module Stream
    ...
    #                             Includes :close_stream_at_end (Boolean) to control whether
    #                             to automatically close the stream after rendering (default: true).
    #
    ...
    #
    # @example
    #   stream_view_containing_react_components(template: 'path/to/your/template', layout: false)
    #
    ...
    def stream_view_containing_react_components(template:, **render_options)
