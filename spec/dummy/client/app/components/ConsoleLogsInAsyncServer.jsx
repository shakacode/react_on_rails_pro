...
const ConsoleLogsInAsyncServer = ({ requestId }) => (
  <div>
    ...
    <div>
      <p>
        If <code>replayServerAsyncOperationLogs</code> is set to <code>true</code> (or not set at all because it's the default value), 
        you should see all logs either logged in sync or async server operations.
      </p>
    ...
    <div>
      <p>
        If <code>replayServerAsyncOperationLogs</code> is set to <code>false</code>, 
        you should see only logs from sync server operations.
      </p>
